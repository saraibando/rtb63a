...
const myImages = [
  "https://res.cloudinary.com/dqinmqte8/image/upload/v1770052396/IMG_0942_doczm9.jpg", // <--- COMA AQUÍ
  "https://res.cloudinary.com/dqinmqte8/image/upload/v1770052386/IMG_0963_ltihom.jpg", // <--- COMA AQUÍ
  "https://res.cloudinary.com/dqinmqte8/image/upload/v1770052396/IMG_0940_npf5lk.jpg", // <--- COMA AQUÍ
  "https://res.cloudinary.com/dqinmqte8/image/upload/v1770052390/IMG_0951_fe8wie.jpg", // <--- COMA AQUÍ
  "https://res.cloudinary.com/dqinmqte8/image/upload/v1770052389/IMG_0956_bdypja.jpg"  // La última no necesita coma, pero si la pones no pasa nada
];
...
const animate = (time) => {
  ...
  const avgVelocity =
    velocityHistory.reduce((sum, val) => sum + val, 0) / velocityHistory.
    length;
